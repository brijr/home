  ...
  return (
    <Section className=''>
      ...
      <p className="text-6xl h-36 md:h-96 md:text-9xl flex max-w-screen md:w-screen lowercase text-black dark:text-white transition-all group">
        <span className='inline group-hover:hidden'>Bridger Tower</span> <span className='hidden group-hover:inline'>bridger.to</span><span className='motion-reduce:animate-spin block md:inline'><Image className='md:w-16 md:ml-2 w-8' width={100} height={100} src="/x.svg" alt='' /></span>
      </p>
